...
\projects{
    ...
    \project{Real-time audio signal processing in C}{2024}{
      ...
      \item{Design allows for several applications to be chained together for interesting results}
    }
    ...
    \project{Lighting controller using Novation Launchpad and Launch Control}{2024}{
      ...
      \item{Windows 10 driver to be unstable, works much more reliably under Linux}
      \item{Eventually moved to Unix sockets communicating between programs \\
        running on the same Linux SBC to decrease latency}
      ...
      \item{Launchpad code written in C using ALSA to reduce IO CPU usage using by utilising poll}
    }
